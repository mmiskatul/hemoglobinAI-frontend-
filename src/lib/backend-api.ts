...
export const authApi = {
  ...
  register: (payload: { name: string; email: string; password: string; role: string }) => backendRequest<{ verification_required: boolean; email: string; message: string }>("/auth/register", { method: "POST", body: JSON.stringify(payload) }),
